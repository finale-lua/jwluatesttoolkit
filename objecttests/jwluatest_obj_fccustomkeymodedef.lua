...
function FCCustomKeyModeDef_ValueTests_ItemNo0(obj)
    ...
    AssureTrue(obj:IsPredefinedMajor(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is predefined major.")
    AssureFalse(obj:IsPredefinedMinor(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is not predefined minor.")
...
function FCCustomKeyModeDef_ValueTests_ItemNo1(obj)
    AssureTrue(obj:IsPredefined(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is predefined.")
    AssureFalse(obj:IsPredefinedMajor(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is not predefined major.")
    AssureTrue(obj:IsPredefinedMinor(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is predefined minor.")
    AssureTrue(obj:IsLinear(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is linear.")
    AssureFalse(obj:IsNonLinear(), "FCCustomKeyModeDef " .. obj.ItemNo .. " is not non-linear.")
