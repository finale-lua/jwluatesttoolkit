...
require("constanttests/consttest_fcclefdef")
require("constanttests/consttest_fccustomsmartlinedef")
require("constanttests/consttest_fcfontinfo")
...
require("constanttests/consttest_fcluascriptitem")
...
require("constanttests/consttest_fcsmartshape")
require("constanttests/consttest_fcsmartshapeentryconnectstyle")
